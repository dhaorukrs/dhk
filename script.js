document.addEventListener("DOMContentLoaded", () => {
  ...
  copyLinkButton.addEventListener("click", () => {
    ...
    customMessage.style.padding = "5px 10px";
    customMessage.style.background = "rgba(0, 0, 0, 0.5)";
    customMessage.style.color = "white";
    customMessage.style.border = "0.1px solid red";
    customMessage.style.borderRadius = "15px";
